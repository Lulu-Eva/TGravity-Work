---
name: tgravity-work-mcn-index
description: TGravity Work MCN 关系索引 Skill。用于扫描本地 MCN Markdown 资产，校验稳定 ID、重复 ID、悬空 relationships、品牌-达人合作矩阵、达人合作历史，并可回填正文 Markdown 双链。触发方式：MCN关系索引、重建MCN索引、品牌达人互链、达人品牌互链、合作历史查询、达人合作过哪些品牌、品牌合作过哪些达人、悬空链接、检查MCN资产、生成品牌达人矩阵、填充Obsidian链接。
---
...
```text
tgravity-work-data/mcn/.backups/fill-links-*/
```
...
```text
tgravity-work-data/mcn/indexes/关系索引.csv
tgravity-work-data/mcn/indexes/关系总览.md
tgravity-work-data/mcn/indexes/品牌-达人矩阵.csv
tgravity-work-data/mcn/indexes/达人合作历史.csv
tgravity-work-data/mcn/indexes/悬空关系检查.md
```
