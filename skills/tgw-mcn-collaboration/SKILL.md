---
name: tgw-mcn-collaboration
description: TGW MCN 合作记录 Skill。用于记录品牌与达人之间的真实合作事实，包括关联品牌、达人、Brief、报价、交付物、执行状态、验收、回款和复盘结论，是品牌-达人互链和合作历史查询的事实表。触发方式：合作记录、合作历史、商单执行、商单复盘、某品牌和某达人合作、执行结果、回款状态、验收结果、记录一次合作。
---
...
python3 scripts/render_mcn_asset.py \
  ...
  --output-dir "$PROJECT_ROOT/tgw-data/mcn/collaborations" \
