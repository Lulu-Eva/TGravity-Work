---
name: tgravity-work-mcn-brand-profile
description: TGravity Work MCN 品牌档案 Skill。用于把品牌方、客户、PR 资源、联系人来源、预算线索、投放偏好、付款和沟通风险整理成结构化 Markdown 品牌档案，支持关联达人、brief 和合作记录引用。触发方式：品牌档案、品牌方档案、品牌资料、品牌线索、这个品牌、记录品牌、更新品牌。
---
...
python3 scripts/render_mcn_asset.py \
  ...
  --output-dir "$PROJECT_ROOT/tgravity-work-data/mcn/brands" \
