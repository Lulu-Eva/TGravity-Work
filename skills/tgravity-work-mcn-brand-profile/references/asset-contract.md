# TGravity Work MCN Asset Contract

This file is the shared source of truth for all MCN asset skills.

## Hard Rules

- Runtime assets live in the user's project under `tgravity-work-data/mcn/`, never inside the skill package.
...
|---|---|---|
| `mcn_creator_profile` | `CRT` | `tgravity-work-data/mcn/creators/` |
| `mcn_brand_profile` | `BRD` | `tgravity-work-data/mcn/brands/` |
| `mcn_reverse_brief` | `BRF` | `tgravity-work-data/mcn/briefs/` |
| `mcn_collaboration` | `COL` | `tgravity-work-data/mcn/collaborations/` |
