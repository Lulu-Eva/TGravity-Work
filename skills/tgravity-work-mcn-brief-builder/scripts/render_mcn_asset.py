#!/usr/bin/env python3
"""Render a TGravity Work MCN asset skeleton from a bundled Markdown template."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Render a TGravity Work MCN Markdown asset skeleton.")
