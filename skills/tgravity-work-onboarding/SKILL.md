...
```text
tgravity-work-prompt-optimizer：精简已有完整提示词。
tgravity-work-prompt-architect：审核提示词架构，或生成提示词框架。
```

说明 `tgravity-work-prompt-optimizer`：
...
说明 `tgravity-work-prompt-architect`：
...
- `tgravity-work-mcn` 只做 MCN 子技能路由。
- `tgravity-work-mcn-creator-profile` 记录达人档案。
- `tgravity-work-mcn-brand-profile` 记录品牌档案。
- `tgravity-work-mcn-brief-builder` 把品牌模糊需求整理成逆向 Brief。
- `tgravity-work-mcn-collaboration` 记录真实合作事实，是品牌达人互链来源。
- `tgravity-work-mcn-index` 从资产 frontmatter 重建关系索引、品牌-达人矩阵和正文阅读链接。
