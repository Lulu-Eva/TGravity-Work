# TGravity Asset Export

## 目标

把指定目录中的 TGravity 资产打包为可迁移、可交接、可审计的资产包。

## 触发

`/tgravity-export`、导出TGravity资产、打包TGravity资产、一键导出资产卡、导出当前项目里的 TGravity 资产。

## 扫描范围

默认只扫描当前项目或用户明确指定目录。

不要默认扫描整台电脑、个人文件夹、聊天记录或敏感资料目录。
