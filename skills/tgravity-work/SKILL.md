---
name: tgravity-work
description: TGravity Work Skills 主入口路由 Skill。只负责识别用户意图并分发到正确的独立子 Skill，不做具体诊断、目标规范、提示词优化、提示词架构、日报、资产卡、搜索、视频、科技画布、发票、项目审视或文件夹整理。触发方式：/tgravity、/tgravity-work、TGravity Work、TGravity工具、我该用哪个TGravity技能、帮我选择工具、开启新手教程、目标提示词、目标规范、目标清晰化、这个问题怎么交给 AI、提示词优化、提示词精简、优化算法、提示词架构、提示词审核、生成提示词框架、倒推提示词、开工前检查、TGravity日报、导出TGravity资产、搜索技能、视频分析技能、科技画布、Codex剪视频、背景动画MP4、可交付MP4、发票报销、大项目行动前审视、项目文件夹整理、生成 AGENTS.md。
---
...
| 目标提示词、目标规范、目标清晰化、把目标说清楚、帮我定义目标、我不知道怎么描述目标、这个目标怎么交给 AI、这个问题怎么交给 AI、/tgravity-goal | `tgravity-work-goal` |
| 提示词优化、提示词精简、精简提示词、压缩提示词、提示词减法、优化算法、把这个提示词变短、/tgravity-prompt-optimizer | `tgravity-work-prompt-optimizer` |
| 提示词架构、提示词审核、审核提示词、评估提示词、优化提示词架构、生成提示词框架、倒推提示词、写一个智能体提示词、/tgravity-prompt-architect | `tgravity-work-prompt-architect` |
...
| 科技画布、Codex剪视频、HyperFrames剪视频、HTML/GSAP动画、脚本驱动剪辑、得到大脑转写稿剪视频、多风格总览站、背景动画MP4、可交付MP4 | `tgravity-work-tech-canvas-video` |
