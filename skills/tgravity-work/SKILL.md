---
name: tgravity-work
description: TGravity Work Skills 主入口路由 Skill。用于用户明确要求打开 TGravity Work、选择 TGravity 子技能、查看工具清单，或不知道该用哪个 TGravity 工具时，只做意图分流，不执行具体业务任务。触发方式：/tgravity、/tgravity-work、TGravity Work、TGravity工具、TGravity有哪些工具、我该用哪个TGravity技能、帮我选择TGravity工具、选择TGravity子技能。
---
