---
name: tgravity-work-mcn-creator-profile
description: TGravity Work MCN 达人档案 Skill。用于把用户口述、聊天记录、后台截图转写、松散文本中的达人信息整理成结构化 Markdown 达人档案，支持缺字段追问、内部/对外字段隔离、关联品牌和合作记录引用。触发方式：达人档案、达人资料、达人画像、这个达人、记录达人、更新达人、补全达人信息。
---
...
python3 scripts/render_mcn_asset.py \
  ...
  --output-dir "$PROJECT_ROOT/tgravity-work-data/mcn/creators" \
...
- 有实际合作事实时，提示用户应创建 `tgravity-work-mcn-collaboration`。
