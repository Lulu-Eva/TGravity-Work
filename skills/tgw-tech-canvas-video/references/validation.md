...
- `hyperframes/index.html` 带 `window.__timelines`、`window.__tgwSetTime`、`.scene.clip`、`.motion-rail`、`.data-column`、`.keyword-chip` 和 `.portrait-safe-zone`。
...
rg "data-composition-id|window.__timelines|window.__tgwSetTime|scene clip|portrait-safe-zone|motion-rail|data-column|keyword-chip|canvasLoad" "$WORKSPACE/hyperframes/index.html"
