...
保存前必须按 `shared/save-boundaries.md` 执行两步确认。
...
品牌、商单、复盘使用专门规则，不在本文件维护第二份字段：

| asset_type | 规则文件 |
|---|---|
| `brand_lead` | `06_brand-cards.md` |
| `deal_progress` | `07_deal-pipeline.md` |
| `deal_review` | `08_deal-review.md` |
| `decision_request` | `04_hitl-hotl-rules.md` 和 `shared/decision-request-card.md` |

## 决策请求卡

决策请求卡的字段和模板以 `shared/decision-request-card.md` 为准。不要在本文件维护第二份模板。
