#!/usr/bin/env python3
"""Validate TGravity Work asset card frontmatter."""
...
from export_assets import is_true, missing_fields, parse_frontmatter


def main() -> None:
    parser = argparse.ArgumentParser(description="Validate TGravity Work asset cards.")
